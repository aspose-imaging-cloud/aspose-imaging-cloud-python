...
class FileVersion(StorageFile):
    ...
    """
    # TODO: fix inheritance, not model
    swagger_types = {
        'name': 'str',
        'is_folder': 'bool',
    ...
    def __init__(self, name=None, is_folder=None, modified_date=None, size=None, path=None, version_id=None,
                 is_latest=None):  # noqa: E501
